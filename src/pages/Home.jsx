  ...
  return (
    <>
      ...
      <div className="grid-2">
         <div style={{ padding: '100px var(--padding-x)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <p className="en-caption" style={{ color: 'var(--color-g80)', marginBottom: '24px' }}>ABOUT KISURA</p>
            <h2 className="tc-h2" style={{ color: 'var(--color-g100)', marginBottom: '32px' }}>用理性的純鈦，<br/>溫柔承載你感性的視界故事</h2>
         ...
         <div style={{ height: 'calc(100vh - 74px)', minHeight: '400px', backgroundImage: 'url(/index/index_13.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
      </div>

      {/* Split Block: AI Recommendation (Left Image, Right Text) */}
      <div className="grid-2">
         <div style={{ height: 'calc(100vh - 74px)', minHeight: '400px', backgroundImage: 'url(/index_9.png)', backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
         <div style={{ padding: '100px var(--padding-x)', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            <p className="en-caption" style={{ color: 'var(--color-g80)', marginBottom: '24px' }}>AI RECOMMENDATION</p>
            <h2 className="tc-h2" style={{ color: 'var(--color-g100)', marginBottom: '32px' }}>不知道哪副眼鏡最適合我？</h2>
            <p className="tc-body" style={{ color: 'var(--color-g80)', marginBottom: '48px', maxWidth: '400px' }}>
      ...
      {/* New Products Slider */}
      <div style={{ padding: '100px var(--padding-x) 0 var(--padding-x)', backgroundColor: 'var(--color-primary-white)' }}>
      ...
      <div id="products" style={{ padding: '100px var(--padding-x)', backgroundColor: 'var(--color-primary-white)' }}>
      ...
      <div style={{ position: 'relative', height: '80vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
         ...
         <div style={{ position: 'relative', zIndex: 1, padding: '80px 60px', textAlign: 'center', maxWidth: '600px' }}>
            <h2 className="tc-h2" style={{ color: '#FFFFFF', marginBottom: '24px' }}>找到最近的商店</h2>
